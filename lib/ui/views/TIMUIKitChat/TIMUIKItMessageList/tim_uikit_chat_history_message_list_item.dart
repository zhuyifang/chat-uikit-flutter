...
class _TIMUIKItHistoryMessageListItemState
  ...
  initTools(
    ...
    tooltip = SuperTooltip(
      ...
      left: left,
      hasArrow: hasArrow,
      borderColor: theme?.wideBackgroundColor ?? Colors.white,//theme?.white ?? Colors.white,
      backgroundColor: theme?.wideBackgroundColor ?? Colors.white,//theme?.white ?? Colors.white,
